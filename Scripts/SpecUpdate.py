...
def spec(bike, startCell, endCell, pageName):
    ...
    for i in range (1, specRangeLength+1):
        ...
        print('\n\n')
        #title
        titleField = (f'/html/body/div[1]/div/div[3]/main/form/div[2]/div[1]/div/div[1]/div[3]/div/div[2]/div/div[1]/div[{i}]/div[4]/div/div[1]/div[2]/input')
        ...
        print(siteTitle)
        print(sheetTitle)
        if(siteTitle != sheetTitle):
            print('     TITLE FIELD DISCREPANCY ENSURE THIS IS NORMAL')
            differentSpec = True


        #value
        valueField = (f'/html/body/div[1]/div/div[3]/main/form/div[2]/div[1]/div/div[1]/div[3]/div/div[2]/div/div[1]/div[{i}]/div[4]/div/div[2]/div[2]/div/div/div[2]')
        ...
        if(siteValue != sheetValue):
            print('     ABOVE field updated')
            differentSpec = True
            x_replace_field(valueField, sheetValue)
    ...
    if (differentSpec == True):
        print('discrepancy detected, Entry UPDATED')
        SaveState = define_save_state()
    else:
