...
#inputs CAD price to relevant bikes
#copied from priceUS

"""
TODO

format into CAD pricing
"""
...
def pricer(bike, priceCell):
    print(f'\n\n    BEGIN price CAD for {bike} \n')
    NavBikes()
    
    price = (priceSheet.cell(row=priceCell, column=3).value)
